...
from brainmaze_torch.signal_generation.DCGAN.model import Discriminator, Generator, DiscriminatorTimeFreq
from brainmaze_torch.signal_generation.DCGAN.dataset import DatasetTimeDomain
from brainmaze_torch._config import ObjDictToDict
